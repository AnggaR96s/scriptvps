...
# Link Hosting Kalian
vpn="raw.githubusercontent.com/AnggaR96s/scriptvps/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${vpn}/addss.sh"
wget -O delss "https://${vpn}/delss.sh"
wget -O cekss "https://${vpn}/cekss.sh"
wget -O renewss "https://${vpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
