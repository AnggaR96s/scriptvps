...
# Link Hosting Kalian
vpn="raw.githubusercontent.com/AnggaR96s/scriptvps/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${vpn}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${vpn}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${vpn}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${vpn}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${vpn}/renewssr.sh && chmod +x /usr/bin/renewssr
