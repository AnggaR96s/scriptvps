...
# Centos 7 & 8 64bit
# My Telegram : https://t.me/MaximumSlav
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/AnggaR96s/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/jnckxyz"
echo -e "${NC}${LIGHT}Telegram : https://t.me/MaximumSlav"
exit 0
fi
# ==================================================
# Link Hosting Kalian
vpn="raw.githubusercontent.com/AnggaR96s/scriptvps/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${vpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${vpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${vpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${vpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${vpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${vpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/slav/data-user-l2tp
touch /var/lib/slav/data-user-pptp
rm -f /root/ipsec.sh
