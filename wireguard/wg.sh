...
# ==================================================
# Link Hosting Kalian
vpn="raw.githubusercontent.com/AnggaR96s/scriptvps/main/wireguard"
...
echo -e "${Info} Wireguard Script Installer"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${vpn}/addwg.sh"
wget -O delwg "https://${vpn}/delwg.sh"
wget -O renewwg "https://${vpn}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
